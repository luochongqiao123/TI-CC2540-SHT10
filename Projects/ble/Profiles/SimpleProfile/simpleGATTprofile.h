...
#define SIMPLEPROFILE_CHARDEVICENAME		5// RW uint8 profile characteristic value
...
#define SIMPLEPROFILE_CHARDEVICENAME_UUID	0xFFF6
...
#define SIMPLEPROFILE_CHARDEVICENAME_LEN		20
